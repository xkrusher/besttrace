...
install(){
	[[ ! -d /home/testrace ]] && wget https://github.com/xkrusher/BestTrace/releases/download/1.1/besttrace4linux.zip && unzip besttrace* && rm *zip
	[[ ! -d /home/testrace ]] && echo -e "${Error} download failed, please check!" && exit 1
