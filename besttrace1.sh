...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget -O BestTrace.tar.gz https://github.com/xkrusher/BestTrace/releases/download/1.0/BestTrace.tar.gz && unzip *zip -d ./besttrace && rm *zip
