...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget -O BestTrace.tar.gz https://github.com/xkrusher/BestTrace/releases/download/1.0/BestTrace.tar.gz && tar -zxf BestTrace.tar.gz && rm BestTrace.tar.gz
